          ...
          <div class="history-content--scroll">
            <div v-for="(item, idx) in historyList" :key="idx" class="history-content--scroll--item">
              ...
              <div class="item-content">
                ...
                <div v-for="(item, idx) in item.events" :key="idx" class="item-content--info" :class="{'accent' : accent = true}">
                ...
                <div class="item-content--info">
                  ...
                  <span class="item-info--text"></span>
                </div>
...
const historyList = [
  {
    year: '2024',
    events: [
      {date: '2024.08', text: '새마을금고 정보시스템 인프라 증설 사업 수주', accent: false},
      {date: '2024.07', text: '새마을금고 정보보호 강화 구푹 사업 수주', accent: false},
