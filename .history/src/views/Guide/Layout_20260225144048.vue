                        ...
                        <tbody>
                            <tr v-for="row in rows" :key="row.id">
                                ...
                                <td class="title" scope="row">
                                    ...
                                    <div v-if="info" class="notice-num">
                                ...
                                <td scope="row" class="num"><time :datetime="row.date">{{ row.date }}</time></td> 
                                <td scope="row" class="num">{{ row.views }}</td>
                            </tr>
...
<script setup>
    const rows = [
        {id: 10, title: '정규직(일반직) 및 계약직 상시채용', info:false, isImportant: true, hasAttachment: true,  date: '2026.02.24', views: 623},
        {id: 9, title: '정규직(일반직) 및 계약직 상시채용', info:false, isImportant: false, hasAttachment: true, date: '2026.02.23', views: 865},
    ]
