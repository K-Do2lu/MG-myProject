    ...
    <div class="main-cont banner">
      ...
      <div class="banner-wrapper">
        <ul class="banner-list">
          <li class="banner-item" v-for="(item, idx) in banners" :key="idx">
      ...
      <div class="banner-indicator">
        <span class="banner-indicator-item" v-for="item in banners" :key="item.img"></span>
      </div>
    </div>
...
const banners = ref([
  {id:img: 'main_img_01.png', alt: '메인 배너 이미지1'},
