    ...
    <div class="base-card-hover">
        ...
        @mouseenter="isActive = true" @mouseleave="isActive = false">
            <div class="hover-type__title">
                <p class="hover-type__title--text">{{ item.title }}</p>
...
const hoverCards = ref([
    ...
    img: '@/assets/images/main_hover_01.png'},
    {title: 'IT 시스템 위탁운영',
    desc: 'IT 인프라 운영부터 전문가 상주지원까지 고객이 안심하고 핵심 업무에 집중 할 수 있도록, IT시스템 일상적 운영에 대한 통합 아웃소싱을 제공합니다.',
    img: '@/assets/images/main_hover_02.png'},
    {title: '금융 점포 통합 전산 서비스스',
    desc: '새마을금고 본, 지점에서 사용하고 있는 IT장비의 납품부터 유지보수까지 새마을금고 창구에서 필요로 하는 모든 종류의 IT서비스를 제공합니다.',
    img: '@/assets/images/main_hover_03.png'},
    {title: '애플리케이션 개발',
    desc: '고객의 요구에 맞추어진 최적의 업무프로그램 이용환경을 제공하기 위하여, 업무프로 개발 및 유지보수를 함께 제공하고 있습니다.',
    img: '@/assets/images/main_hover_04.png'},
    {title: '인프라 통합유지보수수',
    desc: 'IT센터에 위치하는 모든 종류의 IT인프라(H/W, S/W, N/W)를 통합 관리하여 최적의 성능을 유지하고 있습니다.',
    img: '@/assets/images/main_hover_05.png'},
])
...
.base-card-hover{
    ...
    .hover-type{
        ...
        &.active{
            ...
            p{line-height: 1.5;}
            &--text{ margin-bottom: 16px; font-size: ab.$cardHover-font; font-weight: 600;}
