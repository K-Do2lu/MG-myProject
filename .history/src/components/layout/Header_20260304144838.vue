...
{ title: "COMPANY", link: "/sub1", subs: [
    { name: "회사개요", link: "/sub1?tab=overview" },
    { name: "CEO인사말", link: "/sub1?tab=ceo" },
    { name: "연혁", link: "/sub1?tab=history" },
    { name: "오시는 길", link: "/sub1?tab=location" },
    { name: "협력사 소개", link: "/sub1?tab=partners" }
  ]},
  { title: "BUSINESS", link: "/sub2/sub2_1", subs: [{ name: "사업영역", link: "/sub2/sub2_1" }] },
  { title: "NOTICE", link: "/sub3/sub3_1", subs: [
    { name: "공지사항", link: "/sub3/sub3_1" },
    { name: "입찰공고", link: "/sub3/sub3_2" },
    { name: "일정관리", link: "/sub3/sub3_3" }
  ]},
  { title: "RECRUIT", link: "/sub4/sub4_1", subs: [
