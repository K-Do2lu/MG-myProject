...
const hoverCards = ref([
    {title: 'IT 시스템 구축(SI)', desc: 'IT시스템 인프라(H/W, S/W, N/W) 납품, 업무시스템 분석·설계 및 개발, 데이터 설계 및 이관사업까지 고객이 필요한 환경에 맞추어 IT시스템을 구축하여 드립니다.', img: '@/assets/images/main_hover_01.png'},
])
