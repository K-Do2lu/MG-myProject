<template>
    ...
    >
        ...
        <div class="base-modal-banner">
            <!-- banner img -->
             <div class="base-modal-banner--wrap" :style="{transform: `translateX(-${currentIndex * 100}%)`}">
                <div
            ...
            <nav class="base-modal-banner__indicator">
                <button type="button" class="indicator-btn indicator-btn--left" @click="gotoBanner(-1)">
                    <span class="visually-hidden">1번 배너 보기</span>
                </button>
                <span class="indicator-item--count">1/2</span>
                <button type="button" class="indicator-btn indicator-btn--right" @click="gotoBanner(1)">
