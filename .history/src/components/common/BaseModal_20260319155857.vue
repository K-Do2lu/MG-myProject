    ...
    >
        ...
        <div class="base-modal-banner">
            ...
            <nav class="base-modal-banner__indicator">
                <button type="button" class="indicator-btn indicator-btn--left" @click="gotoBanner(-1)" :disabled="disableIndicator">
                    <span class="visually-hidden">1번 배너 보기</span>
                </button>
                <span class="indicator-item--count">{{ currentIndex + 1 }}/{{ banners.length }}</span>
                <button type="button" class="indicator-btn indicator-btn--right" @click="gotoBanner(1)" :disabled="currentIndex === banners.length - 1">
