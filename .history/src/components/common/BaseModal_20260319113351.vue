    ...
    <div class="base-modal" role="dialog" aria-modal="true" aria-labelledby="modal-banner-title">
        ...
        <div class="base-modal-banner">
            ...
            <nav class="base-modal-banner__indicator">
                <button type="button" class="indicator-btn indicator-btn--left">
                    <span class="visually-hidden">1번 배너 보기</span>
                </button>
                <span class="indicator-item--count">1/2</span>
                <button type="button" class="indicator-btn indicator-btn--right">
...
.base-modal{
    ...
    .base-modal-banner{
        ...
        &__indicator{
            @include ab.flex(flex, null, center, center, 10px);
            max-height: 32px;
            position: absolute;
            top: 20px;
            right: 20px;
            border: 1px solid ab.$color-secondary-50;
            border-radius: 50px;
