...
export default createRouter({
  ...
  routes: [
    ...
    {
      path: "/admin/AdminBoardEdit",
      name: "AdminBoardEdit",
      component: () => import("@/views/admin/AdminBoardEdit.vue"),
...

    {
      ...
      component: () => import("@/views/admin/board/NoticeBoard.vue"),
      meta: {requireAuth: false},
    },
    {
      path: "/admin/board/tender",
      name: "AdminBoardTender",
      component: () => import("@/views/admin/board/TenderBoard.vue"),
      meta: {requireAuth: false},
    },    
